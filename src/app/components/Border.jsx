// export const Border = () => {
//   return (
//     <div className=" absolute rounded-full w-[1540px] h-[1540px] border-2 justify-center items-center ">
//       <div className=" rounded-full w-[1340px] h-[1340px] border-2 justify-items-center items-center">
//         <div className="rounded-full w-[940px] h-[940px] border-2 justify-items-center items-center">
//           <div className="rounded-full w-[540px] h-[540px] border-2 justify-items-center items-center">
//             <div className="rounded-full w-[340px] h-[340px] border-2  justify-items-center items-center">
//               <div className=" flex gap-[10px] absolute p-6 rounded-full border-2 border-white w-[140px] h-[140px]   bg-white justify-items-center items-center">
//                 <svg
