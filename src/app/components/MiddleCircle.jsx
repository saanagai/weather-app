  ...
  return (
    <div className="absolute -top-[20%] flex rounded-full w-[1740px] h-[1740px] border-2 justify-center items-center">
      <div className="flex rounded-full w-[1340px] h-[1340px] border-2 justify-center items-center">
        <div className="flex rounded-full w-[940px] h-[940px] border-2 justify-center items-center ">
          <div className="rounded-full flex  w-[540px] h-[540px] border-2 justify-center items-center">
            <div className="rounded-full flex w-[340px] h-[340px] border-2 justify-center items-center">
              <div className=" flex gap-[10px] p-6 rounded-full border-2 border-white w-[140px] h-[140px] justify-center items-center  bg-white">
                <svg
